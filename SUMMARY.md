...
* [Quick Guide to the Certora Prover](README.md)
* [Certora Prover CLI Options](certora-prover-cli-options.md)
...
* [Specification by example](user-manual/specification/README.md)
  ...
  * [The \(Iterable\) Map](user-manual/specification/from-basic-to-advanced/README.md)
    * [A Simple Map](user-manual/specification/from-basic-to-advanced/a-simple-map.md)
    * [An Iterable Map](user-manual/specification/from-basic-to-advanced/an-iterable-map.md)
* [Advanced subjects](user-manual/advanced-subjects/README.md)
  ...
  * [Function Summarization](user-manual/advanced-subjects/function-summarization.md)
  * [Ghosts](user-manual/advanced-subjects/ghosts/README.md)
    * [Ghost Functions](user-manual/advanced-subjects/ghosts/ghost-functions.md)
    * [Hooks](user-manual/advanced-subjects/ghosts/hooks.md)
    * [Definitions](user-manual/advanced-subjects/ghosts/definitions.md)
    * [Multi Contract Hooks](user-manual/advanced-subjects/ghosts/multi-contract-hooks.md)
    * [A Complete Example](user-manual/advanced-subjects/ghosts/a-complete-example-1.md)
  * [Advanced debugging](user-manual/advanced-subjects/advanced-debugging.md)
* [Best Practices](user-manual/best-practices.md)
* [Common Pitfalls](user-manual/common-pitfalls.md)
