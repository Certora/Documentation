...
(a call that will force the prover to havoc storage), a strong invariant will insert the following steps:
 ...
 A full example for `weak` and `strong invariant` can be found in our [Examples Repository](https://github.com/Certora/Examples/blob/master/DEFI/LiquidityPool/README.md). 
