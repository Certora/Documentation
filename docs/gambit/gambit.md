...
You can download prebuilt Gambit binaries for Mac and Linux x86-64 from our
[releases](https://github.com/Certora/gambit/releases) page. For all other platforms, you must build Gambit from source.
