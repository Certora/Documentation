...
(--rule)=
### <a name="rule"></a>`--rule <rule_name_pattern> ...`
...
(--exclude_rule)=
### <a name="exclude_rule"></a> `--exclude_rule <rule_name_pattern>`
...
(--method)=
### <a name="method"></a>`--method <method_signature>`
...
### <a name="parametric_contracts"></a>`--parametric_contracts <contract_name> ...`
...
(--wait_for_results)=
### <a name="wait_for_results"></a>`--wait_for_results`
...
(--multi_assert_check)=
### <a name="multi_assert_check"></a>`--multi_assert_check`
...
(--independent_satisfy)=
### <a name="independent_satisfy"></a>`--independent_satisfy`
...
(--rule_sanity)=
### <a name="rule_sanity"></a>`--rule_sanity`
...
### <a name="short_output"></a>`--short_output`
...
(--compiler_map)=
(--solc_map)=
### <a name="compiler_map"></a>`--compiler_map`
...
(--solc_optimize)=
### <a name="solc_optimize"></a>`--solc_optimize`
...
(--solc_optimize_map)=
### <a name="solc_optimize_map"></a>`--solc_optimize_map`
...
(--solc_via_ir)=
### <a name="solc_via_ir"></a>`--solc_via_ir`
...
### <a name="solc_evm_version"></a>`--solc_evm_version`
...
### <a name="solc_allow_path"></a>`--solc_allow_path`
...
### <a name="packages_path"></a>`--packages_path`
...
(--optimistic_loop)=
### <a name="optimistic_loop"></a>`--optimistic_loop`
...
### <a name="optimistic_summary_recursion"></a>`--optimistic_summary_recursion`
...
### <a name="summary_recursion_limit"></a>`--summary_recursion_limit`
...
### <a name="nondet_difficult_funcs"></a>`--nondet_difficult_funcs`
...
### <a name="nondet_minimal_difficulty"></a>`--nondet_minimal_difficulty`
...
(--optimistic_hashing)=
### <a name="optimistic_hashing"></a>`--optimistic_hashing`
...
### <a name="hashing_length_bound"></a>`--hashing_length_bound`
...
### <a name="compilation_steps_only"></a>`--compilation_steps_only`
...
(--smt_timeout)=
### <a name="smt_timeout"></a>`--smt_timeout <seconds>`
...
(--global_timeout)=
### <a name="global_timeout"></a>`--global_timeout <seconds>`
...
### <a name="struct_link"></a>`--struct_link`
...
### <a name="contract_recursion_limit"></a>`--contract_recursion_limit`
...
### <a name="optimistic_contract_recursion"></a>`--optimistic_contract_recursion`
...
(-optimisticFallback)=
### <a name="optimistic_fallback"></a>`--optimistic_fallback`
...
(--dynamic_bound)=
### <a name="dynamic_bound"></a>`--dynamic_bound <n>`
...
### <a name="dynamic_dispatch"></a>`--dynamic_dispatch`
...
### <a name="prototype"></a>`--prototype <hex string>=<contract>`
...
(--prover_args)=
### <a name="prover_args"></a>`--prover_args`
...
#### <a name="optimisticReturnsize"></a>`--prover_args '-optimisticReturnsize=true'`
...
#### <a name="superOptimisticReturnsize"></a>`--prover_args '-superOptimisticReturnsize=true'`
...
(--precise_bitwise_ops)=
#### <a name="precise_bitwise_ops"></a>`--precise_bitwise_ops`
...
#### <a name="smt_groundQuantifiers"></a>`--prover_args -smt_groundQuantifiers=false`

This option disables quantifier grounding.  See {ref}`grounding` for more
information.

(-maxNumberOfReachChecksBasedOnDomination)=
#### <a name="maxNumberOfReachChecksBasedOnDomination"></a>`--prover_args '-maxNumberOfReachChecksBasedOnDomination <n>'`
...
#### <a name="enableStorageSplitting"></a>`--prover_args '-enableStorageSplitting false'`

This option disables the storage splitting optimization.


(--allow_solidity_calls_in_quantifiers)=
### <a name="allow_solidity_calls_in_quantifiers"></a>`--allow_solidity_calls_in_quantifiers`
...
(-depth)=
### <a name="depth"></a>`--prover_args '-depth <number>'`
...
(-mediumTimeout)=
### <a name="mediumTimeout"></a>`--prover_args '-mediumTimeout <seconds>'`
...
### <a name="dontStopAtFirstSplitTimeout"></a>`--prover_args '-dontStopAtFirstSplitTimeout <true/false>'`
...
### <a name="smt_initialSplitDepth"></a>`--prover_args '-smt_initialSplitDepth <number>'`
